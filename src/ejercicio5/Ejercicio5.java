...
public class Ejercicio5 {
	...
	public static void main(String[] args) {
		...
		File archivotxt = new File(
				"C:\\Users\\diglesias\\eclipse-workspace\\EjercicioFicheros\\src\\ejercicio5\\textoA.txt");
		File escrituraTxt = new File(
				"C:\\Users\\diglesias\\eclipse-workspace\\EjercicioFicheros\\src\\ejercicio5\\escribirA.txt");
		...
		try {
			...
			RandomAccessFile lectura = new RandomAccessFile(archivotxt, "r");
			RandomAccessFile escribir = new RandomAccessFile(escrituraTxt, "rw");
			...
			for (int i = 0; i < 5; i++) {
				...
				// Se mueve el puntero del archivo de escritura a una posicion aleatoria.
				escribir.seek(i);
