...
public class Ejercicio6 {
	...
	public static void main(String[] args) {
		 ...
		 // Se declaran las variables necesarias para manejar las longitudes de los archivos,
	    // las posiciones para la lectura y escritura, y la variable para almacenar el byte leído.
	    long longitudLec = 0;
	    long longitudEsc = 0;
	    long lecPosicion = 0;
	    byte letraLeida = 0;
	    ...
	    File archivotxt = new File("C:\\Users\\diglesias\\eclipse-workspace\\EjercicioFicheros\\src\\ejercicio6\\lecturaAbc.txt");
	    File escrituraTxt = new File("C:\\Users\\diglesias\\eclipse-workspace\\EjercicioFicheros\\src\\ejercicio6\\escrituraAbc.txt");

	    // Se declaran las variables para los objetos RandomAccessFile que se utilizarán para leer y escribir en los archivos.
	    ...
	    try {
	        ...
	        // Abrimos los archivos: 'lecturaAbc.txt' en modo solo lectura ('r') y 'escrituraAbc.txt' en modo lectura/escritura ('rw').
	        ...
	        while (lecPosicion >= 0) {
	            ...
	            // Si el archivo de escritura está vacío, nos aseguramos de que el puntero esté al final
	            if (longitudEsc == 0) {
	                escritura.seek(0);
	            } else {
